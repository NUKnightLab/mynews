...
export default async function FeedPage() {
  ...
  return (
    <main className="flex flex-1 flex-col gap-8 p-8">
      <div>
        <h1 className="text-xl font-semibold">Your Feeds</h1>
        <p className="text-sm text-gray-500">
          The ranked reading view (Phases 4-5) lands here once ingestion
          (Phase 3) is in place. For now, manage which feeds you subscribe
          to.
        </p>
      </div>
